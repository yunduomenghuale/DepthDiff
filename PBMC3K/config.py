...
PBMC3K_TAR = RAW_DIR / "pbmc3k_filtered_gene_bc_matrices.tar.gz"
PBMC3K_EXTRACTED = RAW_DIR / "filtered_gene_bc_matrices" / "hg19"

BENCHMARK_NAME = "fixed_umi"
PROCESSED_NPZ = PROCESSED_DIR / "pbmc3k_fixed_umi_pairs.npz"
